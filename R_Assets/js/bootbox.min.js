(function(a, b) {
    ...
    var m = {
        ...
        inputs: {
            ...
            number: "<input class='bootbox-input bootbox-input-number form-control' autocomplete=off type='number'  placeholder='Add here How Much You want to charge extra from the User' />",
